...
Fork [this GitHub repository](https://github.com/drhelius/foundry-workshop) to your account. You will need to fork the repo in order to modify and use GitHub Actions workflows in later tasks.
